...
const ChecklistDelete = ({ handleDeleteClose, targetId, updateList }) => {
    ...
    async function handleDelete() {
        await axios.delete(`${URL}/checklist/${targetId}`, {
            headers: {
            ...
            <Box sx={{ display: 'flex', justifyContent: 'center', width: "100%" }}>
                <Box sx={{ display: 'flex', backgroundColor: 'white', width: '90%', flexDirection: 'column', p: 2 }}>
                    ...
                    <Box sx={{ p: 3, textAlign: "center" }}>
                        <Typography>Are you sure you want to delete this item? You cannot undo this action.</Typography>
