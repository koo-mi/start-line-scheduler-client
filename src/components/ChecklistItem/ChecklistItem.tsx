...
const ChecklistItem = ({
	...
	return (
		<li className="checklist__item">
			...
			<div
				className={`checklist__item-box ${priority === 'high' ? 'checklist__item-box--high' : ''} ${priority === 'low' ? 'checklist__item-box--low' : ''}`}
			>
				<div className="checklist__item-title-box">
					<h3
						className={`checklist__item-title ${checked ? 'checklist__item-title--crossed' : ''}`}
					>
						{title}
						{isDaily && (
				...
				{description && (
					<div className="checklist__item-description">
						<p
							className={`checklist__item-text ${checked && 'checklist__item-text--crossed'}`}
						>
							{description}
						</p>
					</div>
