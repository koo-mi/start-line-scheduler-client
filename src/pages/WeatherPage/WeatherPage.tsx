		...
		async function getWeather(lat: number, lon: number) {
			try {
				...
				const forecastRes = await axios.get(
					`${FORECAST_API_URL}?lat=${lat}&lon=${lon}&appid=${WEATHER_API_KEY}&units=metric&cnt=4`
				);
			...
			<div className="weather-page__container">
					...
					<div className="weather-page__temp-box">
						...
						<div>
							<div className="weather-page__temp-status">
								<p className="weather-page__temp">
									{Math.round(Number(currentWeather!.main.temp))}&deg;C
								</p>
								<p className="weather-page__status">
				...
				<section className="weather-page__detail-info">
					<div className="weather-page__detail-row">
						<div className="weather-page__detail-box">
							<p className="weather-page__detail-value">
								{Math.round(Number(currentWeather!.main.temp_max))}
							</p>
						...
						<div className="weather-page__detail-box">
							<p className="weather-page__detail-value">
								{formatSunTime(currentWeather!.sys.sunrise)}
							</p>
					...
					<div className="weather-page__detail-row">
						<div className="weather-page__detail-box">
							<p className="weather-page__detail-value">
								{Math.round(Number(currentWeather!.main.temp_min))}
							</p>
						...
						<div className="weather-page__detail-box">
							<p className="weather-page__detail-value">
								{formatSunTime(currentWeather!.sys.sunset)}
							</p>
				...
				<section className="weather-page__forecast">
					<div className="forecast">
						...
						<img
							src={`${WEATHER_ICON_URL}/${forecast[0].weather[0].icon}.png`}
						/>
					...
					<div className="forecast">
						...
						<img
							src={`${WEATHER_ICON_URL}/${forecast[1].weather[0].icon}.png`}
						/>
					...
					<div className="forecast">
						...
						<img
							src={`${WEATHER_ICON_URL}/${forecast[2].weather[0].icon}.png`}
						/>
					...
					<div className="forecast">
						...
						<img
							src={`${WEATHER_ICON_URL}/${forecast[3].weather[0].icon}.png`}
						/>
